        ...
        <article className="text-gray-700 leading-relaxed space-y-4">
          ...
          <div className="space-y-6">
            <section>
              ...
              <p>
                <strong>Como funciona:</strong> O fraudador cria uma mensagem que imita uma empresa confiável (bancos, lojas ou órgãos públicos). A mensagem contém links que levam a sites falsos, onde a vítima insere seus dados.
              </p>
              <p>
                <strong>Exemplo:</strong> &quot;Atualize seus dados bancários agora para evitar o bloqueio da sua conta.&quot;
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                <strong>Como funciona:</strong> O ransomware é instalado ao abrir arquivos infectados ou clicar em links maliciosos. Uma mensagem aparece informando que os dados foram criptografados e só serão liberados após o pagamento.
              </p>
              <p>
                <strong>Exemplo:</strong> Uma tela com o aviso &quot;Seus dados foram criptografados. Pague X bitcoins para recuperá-los.&quot;
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                <strong>Como funciona:</strong> O criminoso engana a vítima para fornecer o código de verificação enviado por SMS. Após obter o código, ele acessa o aplicativo em outro dispositivo.
              </p>
              <p>
                <strong>Exemplo:</strong> Mensagem como &quot;Você recebeu um código por SMS? Envie para mim, é urgente!&quot;
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                <strong>Como funciona:</strong> Usam mensagens para convencer a vítima a realizar a transação. Muitas vezes, criam perfis falsos nas redes sociais ou passam por familiares.
              </p>
              <p>
                <strong>Exemplo:</strong> &quot;Oi, é seu amigo! Troquei meu celular e estou usando outro número. Pode me ajudar com um Pix? Estou precisando para um exame urgente aqui, depois te devolvo.&quot;
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                <strong>Como funciona:</strong> A vítima faz a compra e o pagamento, mas nunca recebe o produto, geralmente em sites falsos que imitam lojas confiáveis.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                <strong>Como funciona:</strong> Pode ser instalado ao baixar softwares de fontes não confiáveis. O fraudador espia atividades como senhas digitadas e histórico de navegação.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                <strong>Como funciona:</strong> O link atrai a vítima com promessas, como &quot;Veja quem visitou seu perfil”. Ao clicar, a vítima é redirecionada para páginas que roubam informações ou instalam malwares.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                <strong>Como funciona:</strong> O fraudador se passa por alguém confiável (suporte técnico, amigo, empresa ou funcionário) e pede informações confidenciais.
              </p>
              <p>
                <strong>Exemplo:</strong> &quot;Sou do suporte do banco. Preciso do seu CPF e senha para resolver um problema na sua conta.&quot;
              </p>
            </section>
          </div>
        </article>
